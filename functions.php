...
if ( ! function_exists( 'bs_prodinfo_setup' ) ) :
	...
	function bs_prodinfo_setup() {
		 ...
		 * If you're building a theme based on bs-prodinfo, use a find and replace
		 * to change 'bs-prodinfo' to the name of your theme in all the template files.
		 */
...
function bs_prodinfo_scripts() {
	...
	wp_enqueue_script( 'bs-prodinfo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'bs-prodinfo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
